...
Initial release of `@exortek/jwk` — JSON Web Key for Node.js 22+.
**RFC 7517** (JWK), **RFC 7518 §6** (per-kty parameters),
**RFC 8037** (Ed25519 / Ed448 / X25519 / X448),
**RFC 8812** (`secp256k1`),
**RFC 7638** (thumbprint), **RFC 9278** (thumbprint URI).
...
- `validate` / `isValid` — strict RFC 7517 §4 + per-kty checks; enforces §4.3 `use`/`key_ops` consistency; `requirePublic` / `requirePrivate` guards.
