...
/**
 * Bind every guard this package calls to PasetoError, so an argument-shape
 * failure anywhere carries one class and one code to branch on.
 *
 * @type {import('@exortek/shared/asserts').WrapFn}
 */
const wrap = (message, extra) => new PasetoError(ErrorCode.INVALID_ARGUMENT, message, extra);
