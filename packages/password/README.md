...
[![tests](https://img.shields.io/badge/tests-122%20passing-brightgreen)](https://github.com/ExorTek/auth/actions/workflows/ci.yml)
...
Codes: `INVALID_ARGUMENT`, `INVALID_PASSWORD`, `INVALID_HASH`, `UNSUPPORTED_ALGORITHM`, `UNSUPPORTED_PARAMS`,
`MISSING_PEER_DEP`, `PASSWORD_TOO_LONG`, `PASSWORD_TOO_SHORT`, `POLICY_VIOLATION`, `BREACHED_PASSWORD`,
`REUSED_PASSWORD`, `HIBP_UNAVAILABLE`.
